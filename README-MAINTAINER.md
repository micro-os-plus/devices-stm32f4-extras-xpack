...
- name the post like: **µOS++ devices-stm32f4 v2.2.1 released**
...
- `npm dist-tag add @micro-os-plus/devices-stm32f4-extras@2.2.1 latest`
- `npm dist-tag ls @@micro-os-plus/devices-stm32f4-extras`
...
- paste the release name like **µOS++ devices-stm32f4 v2.2.1 released**
